    ...
    return (
        <div className="min-h-screen" style={{ backgroundColor: '#F7F1E8' }}>
            ...
            <div className="py-16 md:py-20 px-6 md:px-10" style={{ backgroundColor: '#F7F1E8' }}>
                ...
                <h2 className="text-2xl md:text-3xl font-bold text-center mb-10" style={{ color: '#1B3A2D' }}>
                    Our Amenities
                </h2>
            ...
            <div id="rooms-section" className="py-16 md:py-20 px-6 md:px-10" style={{ backgroundColor: '#2D5A40' }}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 max-w-5xl mx-auto">
                    {[
                        ...
                        >
                            <div className="h-28 md:h-36 flex items-center justify-center text-sm font-medium" style={{ backgroundColor: '#1B3A2D', color: '#C9A84C' }}>
                                Room Photo
                            </div>
