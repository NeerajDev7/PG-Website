...
function Dashboard() {
    ...
    const occupied = rooms.filter(r => tenants.some(t => t.room === `Room ${r.number}`)).length
                ...
                <div className='flex-1 p-4 md:p-8 mt-16 md:mt-0'>
                    <div className='flex justify-between items-center mb-2'>
                        <div>
                            ...
                            <p className='mt-1 text-sm' style={{ color: 'var(--text-secondary)' }}>{getGreeting()}, owner</p>
                        </div>
                        <button
                    ...
                    <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mt-6'>
                        {stats.map((stat) => (
                            ...
                            >
                                ...
                                <p className='text-xs md:text-sm mb-1' style={{ color: 'var(--text-secondary)' }}>{stat.label}</p>
